...
export const EditProfile = (): JSX.Element => {
    ...
    const messages = {
        header: t(`${setlanguage}:editprofile-header`),
        description: t(`${setlanguage}:editprofile-description`),
        editprofileuccessmessage: t(
            `${setlanguage}:editprofile-update-message`
        ),
        ...
        <>
            <div id="addNewArticle">
                ...
                <Form
                    ...
                    submitBtnText={messages.update}
                />
            </div>
            <SnackBar
                messasge={messages.editprofileuccessmessage}
